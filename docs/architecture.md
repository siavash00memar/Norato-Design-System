...
نوراتو یک design system چندفریم‌ورکی است. توکن‌ها در `packages/tokens` تعریف می‌شوند، CSS و markup مشترک در `packages/core-html` قرار دارد و آداپترهای Vue و Next.js رفتار یکسانی را ارائه می‌کنند.
